...
function GetFileInfo(file) {
    return __awaiter(this, void 0, void 0, function () {
        var fileInfo, res, data, basebuffer, fileInfo, fileInfo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    if (!(typeof file == 'string')) return [3 /*break*/, 7];
                    file;
                    if (!/^http/i.exec(file)) return [3 /*break*/, 5];
                ...
                case 4:
                    ...
                    return [2 /*return*/, fileInfo];
                case 5:
                    if (!/^(\/|\.\.?\/|~\/)/i.exec(file)) return [3 /*break*/, 7];
