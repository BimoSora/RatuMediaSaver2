...
var ResultAffectedMessages = /** @class */ (function () {
    function ResultAffectedMessages(results) {
        this.pts = 0;
        this.ptsCount = 0;
 ...
 * ```
 */
function DeleteMessages(snakeClient, chatId, messageId) {
    return __awaiter(this, void 0, void 0, function () {
        var mode, _a, id, type, peer, _b, _c, error_1, botError;
            ...
            switch (_d.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.deleteMessages"));
                    }
                    return [4 /*yield*/, (0, ToBigInt_1.toBigInt)(chatId, snakeClient)];
                case 1:
                    _a = __read.apply(void 0, [_d.sent(), 3]), id = _a[0], type = _a[1], peer = _a[2];
                    if (!(type == 'channel' || type == 'supergroup')) return [3 /*break*/, 3];
                    _b = ResultAffectedMessages.bind;
                    return [4 /*yield*/, snakeClient.client.invoke(new telegram_1.Api.channels.DeleteMessages({
                            channel: peer,
                            id: messageId,
                        }))];
                case 2: return [2 /*return*/, new (_b.apply(ResultAffectedMessages, [void 0, _d.sent()]))()];
                case 3:
                    _c = ResultAffectedMessages.bind;
                    return [4 /*yield*/, snakeClient.client.invoke(new telegram_1.Api.messages.DeleteMessages({
                            revoke: true,
                            id: messageId,
                        }))];
                case 4: return [2 /*return*/, new (_c.apply(ResultAffectedMessages, [void 0, _d.sent()]))()];
