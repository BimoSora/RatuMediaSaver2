 ...
 */
function ExportMessageLink(snakeClient, chatId, messageId, more) {
    return __awaiter(this, void 0, void 0, function () {
        var mode, _a, id, type, peer, error_1, botError;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.exportMessageLink"));
                    }
                    return [4 /*yield*/, (0, ToBigInt_1.toBigInt)(chatId, snakeClient)];
                case 1:
                    _a = __read.apply(void 0, [_b.sent(), 3]), id = _a[0], type = _a[1], peer = _a[2];
                    return [2 /*return*/, snakeClient.client.invoke(new telegram_1.Api.channels.ExportMessageLink(__assign({ channel: peer, id: messageId }, more)))];
                case 2:
                    error_1 = _b.sent();
