 ...
 * ```
 */
function GetUserPhotos(snakeClient, userId, more) {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.getUserPhotos"));
                    }
                    return [4 /*yield*/, (0, ToBigInt_1.toBigInt)(userId, snakeClient)];
                case 1:
                    _a = __read.apply(void 0, [_b.sent(), 3]), id = _a[0], type = _a[1], peer = _a[2];
                    return [4 /*yield*/, snakeClient.client.invoke(new telegram_1.Api.photos.GetUserPhotos({
                            userId: peer,
                ...
                case 3:
                    ...
                    botError.functionArgs = "".concat(userId).concat(more ? ',' + JSON.stringify(more) : '');
                    throw botError;
