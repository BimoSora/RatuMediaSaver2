 ...
 * ```
 */
function GetLeftChannels(snakeClient, offset) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.getLeftChannels"));
                    }
                    return [4 /*yield*/, snakeClient.client.invoke(new telegram_1.Api.channels.GetLeftChannels({
                            offset: offset,
                        }))];
                ...
                case 2:
                    ...
                    botError.functionArgs = "".concat(offset);
                    throw botError;
