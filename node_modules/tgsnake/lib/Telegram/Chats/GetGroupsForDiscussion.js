...
exports.GetGroupsForDiscussion = void 0;
 ...
 * ```
 */
function GetGroupsForDiscussion(snakeClient) {
    return __awaiter(this, void 0, void 0, function () {
        var mode, results, error_1, botError;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.getGroupsForDiscussion"));
                    }
                    return [4 /*yield*/, snakeClient.client.invoke(new telegram_1.Api.channels.GetGroupsForDiscussion())];
                case 1:
                    results = _a.sent();
...
exports.GetGroupsForDiscussion = GetGroupsForDiscussion;
