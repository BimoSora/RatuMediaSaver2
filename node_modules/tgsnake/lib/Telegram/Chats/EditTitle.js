 ...
 */
function EditTitle(snakeClient, chatId, title) {
    return __awaiter(this, void 0, void 0, function () {
        var mode, _a, id, type, results, error_1, botError;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.editTitle"));
                    }
                    return [4 /*yield*/, (0, ToBigInt_1.toBigInt)(chatId, snakeClient)];
                case 1:
                    _a = __read.apply(void 0, [_b.sent(), 2]), id = _a[0], type = _a[1];
                    if (!(type == 'channel')) return [3 /*break*/, 4];
                    return [4 /*yield*/, snakeClient.client.invoke(new telegram_1.Api.channels.EditTitle({
                            channel: id,
                            title: title,
                        }))];
                case 2:
                ...
                case 4: return [2 /*return*/, snakeClient.client.invoke(new telegram_1.Api.messages.EditChatTitle({
                        chatId: id,
                        title: title,
                    }))];
                ...
                case 6:
                    ...
                    botError.functionArgs = "".concat(chatId, ",").concat(title);
                    throw botError;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mode = ['debug', 'info'];
                    if (mode.includes(SnakeClient.logger)) {
                        SnakeClient.log("[".concat(SnakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Creating results telegram.editTitle"));
                    }
