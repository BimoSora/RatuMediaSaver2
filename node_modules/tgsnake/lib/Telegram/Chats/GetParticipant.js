 ...
 * ```
 */
function GetParticipant(snakeClient, chatId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var mode, client, result, _results, error_1, botError;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.getParticipant"));
                    }
                    client = snakeClient.client;
                    return [4 /*yield*/, client.invoke(new telegram_1.Api.channels.GetParticipant({
                ...
                case 1:
                    result = _a.sent();
                    _results = new ChatParticipants_1.ChatParticipants();
                    return [4 /*yield*/, _results.init(result, snakeClient)];
                case 2:
                    _a.sent();
                    return [2 /*return*/, _results.participants[0]];
                case 3:
                    error_1 = _a.sent();
