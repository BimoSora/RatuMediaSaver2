 ...
 * ```
 */
function GetFullChat(snakeClient, chatId) {
    return __awaiter(this, void 0, void 0, function () {
        var mode, _a, id, type, error_1, botError;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (mode.includes(snakeClient.logger)) {
                        snakeClient.log("[".concat(snakeClient.connectTime, "] - [").concat(new Date().toLocaleString(), "] - Running telegram.getFullChat"));
                    }
                ...
                case 1:
                    ...
                    if (type == 'channel' || type == 'supergroup') {
                        return [2 /*return*/, snakeClient.client.invoke(new telegram_1.Api.channels.GetFullChannel({
                                channel: id,
                            }))];
                    }
                    else {
                        return [2 /*return*/, snakeClient.client.invoke(new telegram_1.Api.messages.GetFullChat({
                                chatId: id,
                            }))];
                    }
                    return [3 /*break*/, 3];
