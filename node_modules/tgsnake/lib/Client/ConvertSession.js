...
function ConvertString(session, sessionName) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(sessionName !== '' && session !== '')) return [3 /*break*/, 2];
...
function ConvertStore(sessionName) {
    return __awaiter(this, void 0, void 0, function () {
        var stringsession, storesession;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(sessionName !== '')) return [3 /*break*/, 2];
                    storesession = new sessions_1.StoreSession(sessionName);
                    return [4 /*yield*/, storesession.load()];
                case 1:
                    _a.sent();
