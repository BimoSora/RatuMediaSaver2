...
var big_integer_1 = __importStar(require("big-integer"));
var telegram_1 = require("telegram");
function toBigInt(Ids, SnakeClient) {
    return __awaiter(this, void 0, void 0, function () {
        var e, id, d;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, SnakeClient.telegram.getEntity(Ids, true)];
                case 1:
                    e = _a.sent();
                    id = (0, big_integer_1.default)(String(e.id).replace('-100', '').replace('-', ''));
                    d = e.type == 'channel'
