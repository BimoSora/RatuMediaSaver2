...
declare type TypeUpdate<T = {}> = ResultGetEntity | MessageContext | UpdateChatParticipants | UpdateChatUserTyping | UpdateDeleteMessages | UpdateMessageID | UpdateNewMessage | UpdateShortChatMessage | UpdateShortMessage | UpdateShortSentMessage | UpdateUserStatus | UpdateUserTyping | UpdateNewChannelMessage | UpdateInlineBotCallbackQuery | UpdateBotCallbackQuery | UpdateBotInlineQuery;
interface Context {
    '*': TypeUpdate;
...
export { TypeUpdate, UpdateChatParticipants, UpdateChatUserTyping, UpdateDeleteMessages, UpdateMessageID, UpdateNewMessage, UpdateShortChatMessage, UpdateShortMessage, UpdateShortSentMessage, UpdateUserStatus, UpdateUserTyping, UpdateNewChannelMessage, Context, UpdateInlineBotCallbackQuery, UpdateBotCallbackQuery, UpdateBotInlineQuery, };
