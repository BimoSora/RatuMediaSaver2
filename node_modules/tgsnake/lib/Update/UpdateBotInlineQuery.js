...
var UpdateBotInlineQuery = /** @class */ (function (_super) {
    __extends(UpdateBotInlineQuery, _super);
    function UpdateBotInlineQuery() {
        var _this = _super.call(this) || this;
        _this['_'] = 'updateBotInlineQuery';
        return _this;
    }
    UpdateBotInlineQuery.prototype.init = function (update, SnakeClient) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!update.geo) return [3 /*break*/, 2];
                        this.location = new Media_1.Media();
                        if (!(update.geo instanceof telegram_1.Api.GeoPoint)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.location.encode(update.geo)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
