...
var UpdateShortSentMessage = /** @class */ (function (_super) {
    __extends(UpdateShortSentMessage, _super);
    function UpdateShortSentMessage() {
        var _this = _super.call(this) || this;
        _this['_'] = 'updateShortSentMessage';
        return _this;
    }
    UpdateShortSentMessage.prototype.init = function (update, SnakeClient) {
        return __awaiter(this, void 0, void 0, function () {
            var mode, media, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!update.media) return [3 /*break*/, 3];
                        media = new Media_1.Media();
                        _b = (_a = media).encode;
                        return [4 /*yield*/, media.parseMedia(update.media)];
