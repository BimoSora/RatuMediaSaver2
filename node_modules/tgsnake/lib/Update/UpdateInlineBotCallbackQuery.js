...
var Util_1 = __importDefault(require("tg-file-id/dist/Util"));
var ToBigInt_1 = require("../Utils/ToBigInt");
var UpdateInlineBotCallbackQuery = /** @class */ (function (_super) {
    __extends(UpdateInlineBotCallbackQuery, _super);
    function UpdateInlineBotCallbackQuery() {
        var _this = _super.call(this) || this;
        _this['_'] = 'updateInlineBotCallbackQuery';
        return _this;
    }
    UpdateInlineBotCallbackQuery.prototype.init = function (update, SnakeClient) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var mode, id, accessHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        id = BigInt(String(update.msgId.id));
                        accessHash = BigInt(String(update.msgId.accessHash));
                        //accessHash
                        if (accessHash < BigInt(0)) {
                            this.inlineMessageId += Util_1.default.to64bitBuffer(accessHash * BigInt(-1));
                        }
                        else {
                        ...
                        //id
                        if (id < BigInt(0)) {
                            this.inlineMessageId += Util_1.default.to64bitBuffer(id * BigInt(-1));
                        }
                        else {
