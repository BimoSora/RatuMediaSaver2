...
exports.UpdateChatUserTyping = void 0;
var telegram_1 = require("telegram");
var From_1 = require("../Utils/From");
var Update_1 = require("./Update");
var Chat_1 = require("../Utils/Chat");
var ToBigInt_1 = require("../Utils/ToBigInt");
var UpdateChatUserTyping = /** @class */ (function (_super) {
    __extends(UpdateChatUserTyping, _super);
    function UpdateChatUserTyping() {
        var _this = _super.call(this) || this;
        _this['_'] = 'updateChatUserTyping';
        return _this;
    }
    UpdateChatUserTyping.prototype.init = function (update, SnakeClient) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!update.fromId) return [3 /*break*/, 2];
                        user = new From_1.From();
                        return [4 /*yield*/, user.init(update.fromId, SnakeClient)];
                    case 1:
                        _a.sent();
                        this.user = user;
                        _a.label = 2;
                    case 2:
                        if (!update.chatId) return [3 /*break*/, 4];
...
exports.UpdateChatUserTyping = UpdateChatUserTyping;
