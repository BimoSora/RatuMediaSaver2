...
exports.UpdateShortChatMessage = void 0;
...
var ForwardMessage_1 = require("../Utils/ForwardMessage");
...
var UpdateShortChatMessage = /** @class */ (function (_super) {
    __extends(UpdateShortChatMessage, _super);
    function UpdateShortChatMessage() {
        var _this = _super.call(this) || this;
        _this['_'] = 'updateShortChatMessage';
        return _this;
    }
    UpdateShortChatMessage.prototype.init = function (update, SnakeClient) {
        return __awaiter(this, void 0, void 0, function () {
            var mode, from, chat, fwd, replyTo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!update.fromId) return [3 /*break*/, 5];
                        from = new From_1.From();
                        if (!!update.out) return [3 /*break*/, 2];
                        return [4 /*yield*/, from.init(BigInt((0, ToBigInt_1.toString)(update.fromId)), SnakeClient)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, from.init(SnakeClient.aboutMe.id, SnakeClient)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!update.chatId) return [3 /*break*/, 7];
                        chat = new Chat_1.Chat();
                        return [4 /*yield*/, chat.init(BigInt((0, ToBigInt_1.toString)(update.chatId)), SnakeClient)];
                    case 6:
                        _a.sent();
                        this.message.chat = chat;
                        _a.label = 7;
                    case 7:
                        if (!update.fwdFrom) return [3 /*break*/, 9];
                        fwd = new ForwardMessage_1.ForwardMessage();
                        return [4 /*yield*/, fwd.init(update.fwdFrom, SnakeClient)];
                    case 8:
                        _a.sent();
                        this.message.fwdFrom = fwd;
                        _a.label = 9;
                    case 9:
                        if (!update.replyTo) return [3 /*break*/, 11];
                        replyTo = new ReplyToMessageContext_1.ReplyToMessageContext();
                        return [4 /*yield*/, replyTo.init(update.replyTo, SnakeClient, this.message.chat.id)];
                    case 10:
                        _a.sent();
...
exports.UpdateShortChatMessage = UpdateShortChatMessage;
